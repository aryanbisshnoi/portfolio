...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      {/* Mobile menu */}
      {mobileOpen && (
        <div className="md:hidden fixed inset-0 top-[65px] bg-background/98 backdrop-blur-sm z-40">
          <div className="flex flex-col items-center gap-6 pt-12 px-6">
            {navLinks.map((link) => (
              <a
                ...
                className="text-lg font-medium text-foreground hover:text-muted transition-colors"
              >
                {link.label}
              </a>
            ))}
            <div className="flex gap-3 mt-4">
              <a
                ...
                rel="noopener noreferrer"
                onClick={handleLinkClick}
                className="text-sm font-medium px-5 py-2.5 border-2 border-foreground text-foreground"
              >
                Resume
              </a>
              <a
                href="#contact"
                onClick={handleLinkClick}
                className="text-sm font-medium px-5 py-2.5 bg-foreground text-background"
              >
                Contact
              </a>
            </div>
